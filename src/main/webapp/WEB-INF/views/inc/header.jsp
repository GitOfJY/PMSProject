...
<ul
	...
	<li class="nav-item">
		...
		<div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
			<div class="bg-white py-2 collapse-inner rounded">
				<a class="collapse-item" href="/web/projectCenter.do">프로젝트 센터</a> 
				<a class="collapse-item" href="/web/project/outputslist.do">프로젝트 산출물</a>
			</div>
		</div>
	</li>
	...
	<a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePages" aria-expanded="true" aria-controls="collapsePages"> 
		...
		<div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
			<div class="bg-white py-2 collapse-inner rounded">
				<a class="collapse-item" href="/web/myproject/myworklist.do">작업 리스트</a> 
				<a class="collapse-item" href="/web/myproject/myoutputlist.do">산출물관리</a>
				<a class="collapse-item" href="">일정관리</a> 
				<a class="collapse-item" href="/web/issue/issuelist.do">이슈리스트</a>
			</div>
		</div>
	</li>
